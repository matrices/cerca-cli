...
var cellsApprovalsList = cli.Command{
	Name:    "list",
	...
	Action:          handleCellsApprovalsList,
	HideHelpCommand: true,
}

func handleCellsApprovalsList(ctx context.Context, cmd *cli.Command) error {
	...
	params := cercago.CellApprovalListParams{}
