...
var cellsLogsList = cli.Command{
	...
	Action:          handleCellsLogsList,
	HideHelpCommand: true,
}

func handleCellsLogsList(ctx context.Context, cmd *cli.Command) error {
	...
	params := cercago.CellLogListParams{}
